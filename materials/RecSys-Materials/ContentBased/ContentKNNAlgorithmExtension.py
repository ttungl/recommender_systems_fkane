    ...
    def fit(self, trainset):
        ...
        for thisRating in range(self.trainset.n_items):
            ...
            for otherRating in range(thisRating+1, self.trainset.n_items):
                ...
                mesSimilarity = self.computeMiseEnSceneSimilarity(thisMovieID, otherMovieID, mes) # toggled uncomment.
                self.similarities[thisRating, otherRating] = genreSimilarity * yearSimilarity * mesSimilarity # added mesSimilarity
