...
class ContentKNNAlgorithm(AlgoBase):
    ...
    def fit(self, trainset):
        ...
        for thisRating in range(self.trainset.n_items):
            ...
            for otherRating in range(thisRating+1, self.trainset.n_items):
                ...
                mixYearGenreSimilarity = self.computeMixedYearGenreSimilarity(thisMovieID, otherMovieID, years, genres)
                # self.similarities[thisRating, otherRating] = genreSimilarity * yearSimilarity 
                self.similarities[thisRating, otherRating] = mixYearGenreSimilarity
    ...
    def computeMixedYearGenreSimilarity(self, movie1, movie2, years, genres):
        sumxx = sumyy = sumxy = 0
        genres1, genres2 = genres[movie1], genres[movie2]
        years1, years2 = years[movie1], years[movie2]
        ...
        for i in range(len(genres1)):
            ...
            sumxx += x*x
            sumyy += y*y 
        return sim*(sumxy * math.sqrt(sumxx*sumyy))
